    ...
    public class CarTrade : Callout
    {
        ...
        public override void Process()
        {
            GameFiber.StartNew(delegate
            {
                ...
                if (_Seller.Exists() && _Seller.IsDead && _Buyer.Exists() && _Buyer.IsDead) End();
                if (_Seller.Exists() && Functions.IsPedArrested(_Seller) && _Buyer.Exists() && Functions.IsPedArrested(_Buyer)) End();
