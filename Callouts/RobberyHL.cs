    ...
    public class RobberyHL : Callout
    {
        ...
        public override void Process()
        {
            GameFiber.StartNew(delegate
            {
                ...
                if (A1.Exists() && A1.IsDead && A2.Exists() && A2.IsDead && A3.Exists() && A3.IsDead && A6.Exists() && A6.IsDead && A7.Exists() && A7.IsDead && A8.Exists() && A8.IsDead && A9.Exists() && A9.IsDead) End();
                if (A1.Exists() && Functions.IsPedArrested(A1) && A2.Exists() && Functions.IsPedArrested(A2) && A3.Exists() && Functions.IsPedArrested(A3) && A6.Exists() && Functions.IsPedArrested(A6) && A7.Exists() && Functions.IsPedArrested(A7) && A8.Exists() && Functions.IsPedArrested(A8) && A9.Exists() && Functions.IsPedArrested(A9)) End();
