...
namespace UnitedCallouts.Callouts
{
    ...
    public class K9Backup : Callout
    {
        ...
        public override bool OnBeforeCalloutDisplayed()
        {
            ...
            {
                case 1:
                    this.CalloutMessage = "[UC]~w~ K9 Backup required.";
                    _callOutMessage = 1;
                    break;
                case 2:
                    this.CalloutMessage = "[UC]~w~ K9 Backup required.";
        ...
        {
            Game.LogTrivial("UnitedCallouts Log: K9Backup callout accepted.");
            Game.DisplayNotification("web_lossantospolicedept", "web_lossantospolicedept", "~w~UnitedCallouts", "~y~K9 Backup", "~b~Dispatch:~w~ A Cop needs a K9-Unit for a traffic stop. Respond with ~y~Code 2~w~.");
        ...
        public override void Process()
        {
            GameFiber.StartNew(delegate
            {
                ...
                if (_V.Exists() && _V.IsDead) End();
                if (_V.Exists() && Functions.IsPedArrested(_V)) End();
            }, "K9Backup [UnitedCallouts]");
            base.Process();
        }
        ...
        public override void End()
        {
            ...
            if (_Blip.Exists()) _Blip.Delete();
            Game.DisplayNotification("web_lossantospolicedept", "web_lossantospolicedept", "~w~UnitedCallouts", "~y~K9-Backup", "~b~You: ~w~Dispatch we're code 4. Show me ~g~10-8.");
