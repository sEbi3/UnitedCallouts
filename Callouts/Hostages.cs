...
namespace UnitedCallouts.Callouts
{
    ...
    internal class Hostages : Callout
    {
        ...
        public override bool OnBeforeCalloutDisplayed()
        {
            ...
            CalloutMessage = "[UC]~w~ A group of criminals took hostages.";
        ...
        public override void Process()
        {
            GameFiber.StartNew(delegate
            {
                ...
                if (_AG1.Exists() && _AG1.IsDead && _AG2.Exists() && _AG2.IsDead) End();
                if (_AG1.Exists() && Functions.IsPedArrested(_AG1) && _AG2.Exists() && Functions.IsPedArrested(_AG2)) End();
