...
{
    [CalloutInfo("ArrestWarrant", CalloutProbability.Medium)]
    public class ArrestWarrant : Callout
    {
        ...
        public override bool OnBeforeCalloutDisplayed()
        {
            ...
            {
                case 1:
                    CalloutMessage = "~b~Dispatch:~s~ Arrest Warrant";
                    _callOutMessage = 1;
                    break;
                case 2:
                    CalloutMessage = "~b~Dispatch:~s~ Arrest Warrant";
        ...
        {
            Game.LogTrivial("UnitedCallouts Log: ArrestWarrant callout accepted.");
            Game.DisplayNotification("web_lossantospolicedept", "web_lossantospolicedept", "~w~UnitedCallouts", "~y~Arrest Warrant", "~b~Dispatch:~w~ Try to ~o~speak~w~ and ~b~arrest~w~ the wanted person. Respond with ~r~Code 3");
        ...
        public override void End()
        {
            ...
            if (_Blip.Exists()) _Blip.Delete();
            Game.DisplayNotification("web_lossantospolicedept", "web_lossantospolicedept", "~w~UnitedCallouts", "~y~Arrest Warrant", "~b~You: ~w~Dispatch we're code 4. Show me ~g~10-8.");
