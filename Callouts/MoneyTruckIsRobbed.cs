...
namespace UnitedCallouts.Callouts
{
    ...
    class MoneyTruckIsRobbed : Callout
    {
        ...
        public override bool OnBeforeCalloutDisplayed()
        {
            ...
            this.CalloutMessage = "[UC]~w~ Reports of a money truck theft.";
        ...
        public override void Process()
        {
            GameFiber.StartNew(delegate
            {
                ...
                if (_Aggressor1.Exists() && _Aggressor1.IsDead && _Aggressor2.Exists() && _Aggressor2.IsDead && _Aggressor3.Exists() && _Aggressor3.IsDead && _Aggressor4.Exists() && _Aggressor4.IsDead) End();
                if (_Aggressor1.Exists() && Functions.IsPedArrested(_Aggressor1) && _Aggressor2.Exists() && Functions.IsPedArrested(_Aggressor2) && _Aggressor3.Exists() && Functions.IsPedArrested(_Aggressor3) && _Aggressor4.Exists() && Functions.IsPedArrested(_Aggressor4)) End();
