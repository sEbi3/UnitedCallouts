...
{
    [CalloutInfo("Troublemaker", CalloutProbability.Medium)]
    public class troublemaker : Callout
    {
        ...
        public override bool OnBeforeCalloutDisplayed()
        {
            ...
            {
                case 1:
                    this.CalloutMessage = "~b~Dispatch:~s~ Troublemaker at Metro station";
                    _callOutMessage = 1;
                    break;
                case 2:
                    this.CalloutMessage = "~b~Dispatch:~s~ Troublemaker at Metro station";
                    ...
                    if (_attack == false && _subject.DistanceTo(Game.LocalPlayer.Character) < 2f && Game.IsKeyDown(Settings.Dialog))
                    {
                        ...
                        switch (_storyLine)
                        {
                            ...
                            case 5:
                                ...
                                if (_callOutMessage == 2)
                                {
                                    Game.DisplaySubtitle("~r~troublemaker: ~w~Fuck off! (5/5)", 5000);
