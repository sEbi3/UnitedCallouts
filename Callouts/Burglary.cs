    ...
    public class Burglary : Callout
    {
        ...
        public override void Process()
        {
            GameFiber.StartNew(delegate
            {
                ...
                {
                    if (_Blip.Exists()) _Blip.Delete();
                    Game.DisplayNotification("web_lossantospolicedept", "web_lossantospolicedept", "~w~UnitedCallouts", "~y~Burglary into an apartment", "~b~Dispatch: ~w~You should be in the near of the ~y~apartment~w~. Try to arrest the ~o~burglar~w~.");
