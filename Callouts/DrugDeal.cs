    ...
    public class DrugDeal : Callout
    {
        ...
        public override void Process()
        {
            GameFiber.StartNew(delegate
            {
                ...
                if (_Victim.Exists() && _Victim.IsDead && _Dealer.Exists() && _Dealer.IsDead) End();
                if (_Victim.Exists() && Functions.IsPedArrested(_Victim)  && _Dealer.Exists() && Functions.IsPedArrested(_Dealer)) End();
